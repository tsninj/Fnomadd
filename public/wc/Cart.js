class CartComponent extends HTMLElement {
                ...
                cartHTML += `
                    <article class="contain1" id="book-${product.id}">
                        ...
                        <div>
                            ...
                            <div style="background:none" class="quantity-controls">
                                <button class="decrease" data-id="${product.id}">-</button>
                                <span class="quantity">${quantity}</span>
                                <button class="increase" data-id="${product.id}">+</button>
                            </div>
                            <button style="position: absolute; /* Элементийг карт дотроо харьцангуй байрлуулна */
    top: 8px;
    right: 8px; 
    border: none;
    background: none;
    width: 24px;
    height: 24px;
    border-radius: 50%; /* Товчийг дугуй болгох */
    font-size: 1rem;
    display: flex;
    justify-content: center;
    align-items: center;
    cursor: pointer;
    transition: background 0.3s ease;" class="remove-item" data-id="${product.id}">X</button>
                        </div>
                    </article>
                `;
            }
    ...
    `;
        ...
        template.innerHTML = `
            ...
            .quantity-controls {  display: flex; background: none; align-items: center; justify-content: center; gap: 10px; padding: 0; margin: 0;}
